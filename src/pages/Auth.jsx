      ...
      <div className={styles.authContainer}>
        ...
        <form className={styles.authForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            {!isLogin && (
              <small className={styles.helpText}>Must be at least 8 characters</small>
            )}
          </div>
        ...
        {/* Admin access — subtle, always visible */}
        <div className={styles.adminAccess}>
          <a href="/admin/login" className={styles.adminAccessLink}>
            Admin login
          </a>
        </div>
