...
const EPISODES = [
  ...
  },
  {
    ...
    comingSoon: true,
    desc: `Every conversation in RYZE Intelligence disappears the moment you refresh the page. Close the tab. Navigate away. Come back tomorrow. Gone.

That's the difference between a demo and a real product.

Episode 8 is about fixing that — building persistent chat history directly into RYZE Intelligence. Same pattern as ChatGPT and Claude.ai:

→ Every conversation saved to the database automatically
→ Sidebar shows past sessions grouped by date — Today, Yesterday, This Week
→ Titles auto-generated by AI after the first exchange
→ Click any past session and the full thread reloads — including inline candidate cards
→ Delete sessions to keep things clean as you test and iterate

Two new database tables. Five new API endpoints. One sidebar component. One big step from demo to product.
